...
| :----------------: | :------------------: | :----: | :---------: |
| `FILE_SERVICE_IP` | File Service Address | String | `127.0.0.1` |
| `FILE_SERVICE_PORT` | File Service Port Number | Integer | `8000` |
| `CONSUL_HOST` | Consul Registry Address | String | `127.0.0.1` |
| `CONSUL_PORT` | Consul Registry Port Number | Integer | `8500` |
...
- For `FILE_SERVICE_IP`and `FILE_SERVICE_PORT`, fill in the configuration corresponding to the gateway. In the distributed case, the corresponding request is always forwarded through the gateway.
