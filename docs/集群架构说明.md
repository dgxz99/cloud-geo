...
此时，用户可以得到上传后，文件直链为：`http://127.0.0.1:9000/api/file/retrieve/eaecda4d05cb4031a0778d52b0601f7f.zip`
...
```json
{
	...
	"inputs": {
		"INPUT": {
			"type": "reference",
			"href": "http://127.0.0.1:9000/api/file/retrieve/eaecda4d05cb4031a0778d52b0601f7f.zip"
		}
	}
}
```
...
```json
{
	"status": {
		"status": "succeeded",
		"time": "2024-06-09T21:33:49Z",
		"percent_done": "100",
		"message": "PyWPS Process Buffer finished"
	},
	"outputs": {
		"OUTPUT": "<![CDATA[http://127.0.0.1:9000/api/file/retrieve/native-buffer-output-27b3bb2c-f9b8-47ae-a191-bc9fe9f30a47.zip]]>"
	}
}
```
...
```json
{
	...
	"inputs": {
		"INPUT": {
			"type": "reference",
			"href": "http://127.0.0.1:9000/api/file/retrieve/01baccc3b92d429087eeed0731ce2006.zip"
		}
	}
}
```
...
```json
{
	"job-id": "ca287e9d48d8434a93a8699bf7237efe",
	"result": null,
	"status": "Running"
}
```

要想获取算子执行状态或者结果，用户可以使用上述JobID进行查询，向`http://127.0.0.1:9000/api/wps/job/ca287e9d48d8434a93a8699bf7237efe`发起GET请求，结果如下：

```json
{
	"job-id": "2284cb713fed4f789946d529ad0e6ffa",
	"result": {
		"OUTPUT": "<![CDATA[http://127.0.0.1:9000/api/file/retrieve/e06e23c13b174f01a56062fd95956ab2.zip]]>"
	},
	"status": "Succeeded"
}
```
